...
Master's research code for the paper **"An Operator-Based Approach for Modeling
Influence Diffusion in Complex Social Networks"** (*Journal of Social Computing*, 2021).
